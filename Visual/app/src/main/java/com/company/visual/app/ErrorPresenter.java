...
public interface ErrorPresenter {
     ...
     * application's user.
     *
     * @param eTitle short title for the error
     * @param eDetail detailed error description, which contains also the consequences of
     *                the problem
     ...
     */
    public void presentError(String eTitle, String eDetail, Exception e, boolean isFatal);
}
